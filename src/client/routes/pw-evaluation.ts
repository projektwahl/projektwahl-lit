    ...
    protected render() {
      return html`
        ...
        <div class="container">
          ...
          <p>
            Zuerst einmal vorneweg: Wer sich von der Richtigkeit der Angaben
            ...
            aller Personen veröffentlicht werden müsste. Aber mit Hilfe des
            Codes kann zumindest überprüft werden, ob das Ergebnis plausibel
            ist.
          </p>
          ...
          <p>
            ...
            Projekten zugewiesen werden, die von der Altersbeschränkung her
            passen (und solche zufälligen Zuweisungen erlauben). Man kann nicht
            ein Projekt wählen, in dem man Projektleiter ist.
          </p>
          ...
          <p>
            ...
            Überbelegen oder Unterbelegen von Projekten. Dadurch sieht man dann,
            bei welchen Projekten man am Besten die Größe ändert. Wenn dies
            nicht möglich ist, kann man (bald) für einzelne Projekte dies
            deaktivieren.
          </p>
