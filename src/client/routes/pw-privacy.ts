  ...
  protected render() {
    return html`
      ...
      <div class="container">
        ...
        >
        von der oben genannten Quelle aus dem Schülerstammverzeichnis. Diese werden in
        Einklang mit
        <a
          href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&from=DE#d1e2370-1-1"
          >Artikel 14 Absatz 2a DSGVO</a
        ...
        verarbeitet:<br />
        welches Projekt man ggf. leitet, in welchem Projekt man ist, gewählte Projekte (inklusive vergangene Änderungen), Daten in
        ...
        ><br />
        Mit dem Serverhoster <a href="https://www.hetzner.com/de/">Hetzner</a> wurde ein Auftragsverarbeitungsvertrag nach
        <a
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>Es werden regelmäßig Sicherheitskopien der Daten erstellt.</li>
