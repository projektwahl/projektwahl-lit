...
*/
import { ResponseType, routes } from "../lib/routes.js";
import type { z } from "zod";
export declare const myFetch: <P extends "/api/v1/users" | "/api/v1/projects" | "/api/v1/choices" | "/api/v1/sessions" | "/api/v1/settings" | "/api/v1/logout" | "/api/v1/login" | "/api/v1/sudo" | "/api/v1/openid-login" | "/api/v1/redirect" | "/api/v1/sleep" | "/api/v1/update" | "/api/v1/users/create-or-update" | "/api/v1/projects/create" | "/api/v1/projects/update" | "/api/v1/choices/update" | "/api/v1/settings/update">(method: "GET" | "POST", url: P, body: z.TypeOf<{
...
}[P]["request"]>, options: RequestInit) => Promise<ResponseType<P>>;
export declare const sleep: (timeout: number) => Promise<void>;
export declare const suspend: () => Promise<void>;
type PathTree<T> = {
